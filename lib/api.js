...
export const api = {
  ...
  studioBlueprint: (d) => call('/api/studio/blueprint', 'POST', d),
  studioBuild: (d) => call('/api/studio/build', 'POST', d),            // Full site plan
  ...
  competitorProfile: (d) => call('/api/backlinks/competitor', 'POST', d),
  linkGap: (d) => call('/api/backlinks/link-gap', 'POST', d),
  // Opportunity Engine
  analyzeOpportunity: (d) => call('/api/opportunity/keyword', 'POST', d),
  mineWinnerSite: (d) => call('/api/opportunity/mine-site', 'POST', d),
  multiCountryScan: (d) => call('/api/opportunity/multi-country', 'POST', d),
  mineVertical: (d) => call('/api/opportunity/vertical', 'POST', d),
  getVerticals: () => call('/api/opportunity/verticals'),
  // Niche catalog
  browseNiches: (q = {}) => call(`/api/niches?${new URLSearchParams(q)}`),
  getNicheTree: () => call('/api/niches/tree'),
  getNicheStats: () => call('/api/niches/stats'),
  getNichePlan: (id) => call(`/api/niches/${id}/plan`),
  // Amazon taxonomy + keyword banks
  getTaxonomy: () => call('/api/affiliate/taxonomy'),
  affiliateKeywords: (d) => call('/api/affiliate/keywords', 'POST', d),
  ecommerceKeywords: (d) => call('/api/ecommerce/keywords', 'POST', d),
  getCountryScores: (q = {}) => call(`/api/opportunity/countries?${new URLSearchParams(q)}`),
  getDataStatus: () => call('/api/data/status'),
  affiliateBestKeywords: (d) => call('/api/affiliate/best-keywords', 'POST', d),
  // GSC Intelligence
